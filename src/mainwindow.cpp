      ...
      m_settingsDialog(nullptr)
{
    ...
    // File/View menus already contain the core actions, and Measure delta t is added to View below.
    if (ui->toolBar)
...
QString MainWindow::getPnsStatusText() const
{
...
void MainWindow::updatePnsStatusIndicator()
{
    ...
    // This method remains as a lightweight compatibility hook for existing callers.
}
...
void MainWindow::showUsage()
{
    QMessageBox::information(this, "Usage Guide",
        ...
        "- <b>Zoom / Pan:</b> Controlled by Settings -> Interactions. (Default: Zoom = Mouse wheel; Pan = Drag.)<br>"
